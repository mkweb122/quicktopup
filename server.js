...
app.get(
    ...
    (req, res) => {
        ...
        return res
            .status(404)
            .send(
                "QuickTopUp homepage not found. Please upload index.html."
            );
            ...
            if (
                ...
                return res
                    ...
                    .json({
                        ...
                        message:
                            "Only MTN data is currently available."
                ...
                return res
                    ...
                    .json({
                        ...
                        message:
                            ...
                            "Could not fetch MTN data plans.",
